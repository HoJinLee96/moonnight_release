...
public class AdminQuestionController {
	...
	public ResponseEntity<ApiResponseDto<AdminQuestionResponseDto>> verifyPasswordForView(
		...
		AdminQuestionResponseDto resDto = adminQuestionService.getQuestion(questionId);
	...
	public ResponseEntity<ApiResponseDto<AdminQuestionResponseDto>> modifyQuestion(
		...
		AdminQuestionResponseDto resDto = adminQuestionService.modifyQuestion(customAdminDetails.getAdminId(), questionId, dto);
...
//		
//		AdminQuestionResponseDto resDto = adminQuestionService.updateQuestionStatus(customAdminDetails.getAdminId(), questionId, dto);
//	return ResponseEntity.ok(apiResponseFactory.success(UPDATE_SUCCESS, resDto));
//	}
