...
@NoArgsConstructor
@AllArgsConstructor
public class AdminSignUpTokenDto implements Encryptable<AdminSignUpTokenDto>{
	...
	@Override
	public AdminSignUpTokenDto encrypt(AesProvider aesProvider) {
        return new AdminSignUpTokenDto(
	...
	@Override
	public AdminSignUpTokenDto decrypt(AesProvider aesProvider) {
        return new AdminSignUpTokenDto(
