...
export async function updatePassword(password, confirmPassword) {
	...
	const response = await fetch("/api/admin/public/update/pw", {
		method: "PATCH",
		headers: { "Content-Type": "application/x-www-form-urlencoded" },
...
export async function updateProfile(profileData) {
	...
	const response = await fetch("/api/admin/private/update/profile", {
		method: "PATCH",
...
export async function isEmailExist(email) {
	...
	const response = await fetch("/api/admin/public/exist/email", {
		method: "POST",
		headers: { "Content-Type": "application/x-www-form-urlencoded" },
		body: new URLSearchParams({ email })
	});
...
export async function isEmailExistForFindEmail(phone) {
	...
	const response = await fetch("/api/admin/public/find/email/by/phone", {
		method: "POST",
		headers: { "Content-Type": "application/x-www-form-urlencoded" },
		body: new URLSearchParams({ phone })
	});
...
export async function isEmailExistForConvertToLocal(email) {
	...
	const response = await fetch("/api/admin/private/exist/email/convert", {
		method: "POST",
		headers: { "Content-Type": "application/x-www-form-urlencoded" },
		body: new URLSearchParams({ email })
	});
...
export async function isEmailExistsForFindPassword(email) {
	...
	const response = await fetch("/api/admin/public/exist/email/find/password", {
		method: "POST",
		headers: { "Content-Type": "application/x-www-form-urlencoded" },
		body: new URLSearchParams({ email })
	});
...
export async function isPhoneExist(phone) {
	...
	const response = await fetch("/api/admin/public/exist/phone", {
		method: "POST",
		headers: { "Content-Type": "application/x-www-form-urlencoded" },
		body: new URLSearchParams({ phone })
	});
